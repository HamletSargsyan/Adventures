...
class Shop:
    ...
    def buy(self, item_name, quantity):
        if item_name in self.items:
            ...
            if item["Цена"] * quantity <= items["Монеты"]["Количество"]:
                ...
                items["Монеты"]["Количество"] -= (
                    item["Цена"] * quantity
                )  # Уменьшаем Монеты игрока
                item[
                    "Количество"
                ] += quantity  # Увеличиваем количество купленных предметов
    ...
    def sell(self, item_name, quantity):
        if item_name in self.items:
            ...
            if item["Количество"] >= quantity:
                ...
                item[
                    "Количество"
                ] -= quantity  # Уменьшаем количество проданных предметов
                alert(
    ...
    def get_available_items(self):
        ...
        available_items = [
            f"{item} ({self.items[item]['Количество']})"
...
def shop():
    ...
    if choice == "Назад":
        ...
        try:
            quantity = int(
                input(f"Введите количество (у вас {items[item_name]['Количество']}): ")
