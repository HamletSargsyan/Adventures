...
class _mobs:
    def mobs_forest_guide():
        print("Встретился Лесной проводник.")
        print("Способности: Навык обнаружения (может помочь игроку обнаружить сокровища или скрытые пути в лесу)")
        # TODO: Реализация способности "Навык обнаружения"

    def mobs_forest_spirit():
        print("Встретился Речной дух.")
        print("Способности: Исцеление водой (может исцелять игрока, когда они находятся рядом с водой)")
    ...
    def mobs_forest_keeper():
        print(Fore.LIGHTGREEN_EX + "Встретился Хранитель леса.")
        print("Способности: Связь с природой (может помочь игроку обнаружить редкие растения или существа в лесу)")
        # TODO: Реализация способности "Связь с природой"
        


    def mobs_forest_trader():
        print("Встретился Торговец.")
        print("Способности: Торговля (игрок может приобрести у него полезные предметы и экипировку)")
        # TODO: Реализация способности "Торговля"
    ...
    def mobs_foret():
        ...
        if chance == 1 or 3 or 7:
            mob = random.choice(mobs)
            if mob == "Лесной проводник":
                pass #TODO Способности: Навык обнаружения (может помочь игроку обнаружить сокровища или скрытые пути в лесу)
            elif mob == "Речной дух":
                clear()
                print(Fore.LIGHTGREEN_EX + "Встретился Речной дух.")
                print("Способности: Исцеление водой (может исцелять игрока, когда они находятся рядом с водой)")
                print(f"Цена: 100 монет\nУ тебя {items['Монеты']}монет")
                try:
                    choice = int(input("\n1. Подойти"
                                        "2. Уйти\n>>> "))
                except ValueError:
                    ...
                    pass
                if choice == 1:
                    _mobs.mobs_forest_spirit()
                elif choice == 2:
                    pass
            elif mob == "Хранитель леса":
                print(Fore.LIGHTGREEN_EX + "Встретился Хранитель леса.")
                print("Способность: Связь с природой (может помочь игроку обнаружить редкие растения или существа в лесу)")

                _mobs.mobs_forest_keeper()
            elif mob == "Торговец":
                pass #TODO Способности: Торговля (игрок может приобрести у него полезные предметы и экипировку)
